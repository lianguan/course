...
func TestHandler_adminUpdateSchoolSettings(t *testing.T) {
	type mockBehavior func(r *mock_service.MockSchools, schoolID uint, input domain.UpdateSchoolSettingsInput)
	...
	tests := []struct {
	...
	}{
		{
			...
			mockBehavior: func(r *mock_service.MockSchools, schoolID uint, input domain.UpdateSchoolSettingsInput) {
...
func TestHandler_adminCreatePromocode(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			statusCode:   201,
			responseBody: fmt.Sprintf(`{"id":%d}`, promocodeID),
		},
		{
...
func TestHandler_adminGetPromocodes(t *testing.T) {
	type mockBehavior func(r *mock_service.MockPromoCodes, schoolId uint)

	type offersMockBehavior func(r *mock_service.MockOffers, offerIds []uint)
	...
	tests := []struct {
	...
	}{
		{
			name:   "ok",
			school: school,
			mockBehavior: func(r *mock_service.MockPromoCodes, schoolId uint) {
			...
			offersMockBehavior: func(r *mock_service.MockOffers, offerIds []uint) {
			...
			statusCode:   200,
			responseBody: fmt.Sprintf(`{"data":[{"id":%d,"code":"FIRSTPROMO","discountPercentage":15,"expiresAt":"2022-12-10T13:49:51Z","offers":[{"id":%d,"name":"offer"}]}],"count":0}`, promocodeId, offerId),
		},
		{
			name:   "service error",
			school: school,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.offersMockBehavior(o, []uint{offerId})
...
func TestHandler_adminGetPromocodeById(t *testing.T) {
	type mockBehavior func(r *mock_service.MockPromoCodes, schoolId uint, id uint)
	...
	tests := []struct {
	...
	}{
		{
			name:   "ok",
			school: school,
			mockBehavior: func(r *mock_service.MockPromoCodes, schoolId uint, id uint) {
			...
			statusCode:   200,
			responseBody: fmt.Sprintf(`{"id":%d,"code":"FIRSTPROMO","discountPercentage":15,"expiresAt":"2022-12-10T13:49:51Z","offers":[{"id":%d,"name":"offer"}]}`, promocodeId, offerId),
		},
		{
			name:   "service error",
			school: school,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create Request
			w := httptest.NewRecorder()
			req := httptest.NewRequest("GET", fmt.Sprintf("/admins/promocodes/%d", promocodeId), nil)
...
func TestHandler_adminDeletePromocode(t *testing.T) {
	type mockBehavior func(r *mock_service.MockPromoCodes, schoolId, id uint)
	...
	tests := []struct {
	...
	}{
		{
			name:   "ok",
			school: school,
			mockBehavior: func(r *mock_service.MockPromoCodes, schoolId, id uint) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create Request
			w := httptest.NewRecorder()
			req := httptest.NewRequest("DELETE", fmt.Sprintf("/admins/promocodes/%d", promocodeId), nil)
...
func TestHandler_adminDeleteCourse(t *testing.T) {
	type mockBehavior func(r *mock_service.MockCourses, schoolId, id uint)
	...
	tests := []struct {
	...
	}{
		{
			...
			school:   school,
			courseId: 1,
			mockBehavior: func(r *mock_service.MockCourses, schoolId, id uint) {
				r.EXPECT().Delete(context.Background(), schoolId, id).Return(nil)
			},
			statusCode:   200,
			responseBody: "",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create Request
			w := httptest.NewRecorder()
			req := httptest.NewRequest("DELETE", fmt.Sprintf("/admins/courses/%d", tt.courseId), nil)
